...
namespace StudentGrades.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Иванов Михаил Юрьевич", Visual=2, Architecture=1, Networks=1, Calculate_Math=2, PI=2, Math=1, Electric=2},
                new Student{Name="Смирнов Илья Дмитриевич", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
                new Student{Name="Соболев Иван Иванович", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
